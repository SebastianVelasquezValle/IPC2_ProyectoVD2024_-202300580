...
class ListaDoble:
    ...
    '''
        ...
        #generamos la imagen
        ruta_imagen = 'reportes/ListaSolicitantes.png'
        comando = 'dot -Tpng ' + ruta_dot + ' -o ' + ruta_imagen # Si quiere cambiar el formato de la imagen, cambie el -Tpng por -Tsvg (pero no olvide cambiar la extensión del archivo de salida a svg)
        os.system(comando)
