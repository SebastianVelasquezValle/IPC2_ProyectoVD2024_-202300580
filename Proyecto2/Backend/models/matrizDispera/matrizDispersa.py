...
from models.matrizDispera.listaCabecera import ListaCabecera
from models.matrizDispera.nodoCabecera import NodoCabecera
from models.matrizDispera.nodoCelda import NodoCelda
...
class MatrizDispersa:
            ...
            #3.1.2.2 Si la columna del nuevo nodo es mayor a la columna del ultimo nodo interno
                ...
                while actual != None:
                    ...
                    #SI LA POSICION EN X y Y DEL NUEVO NODO ES IGUAL A LA POSICION EN X y Y DEL NODO ACTUAL
                        ...
                        #SI QUEREMOS SOBREESCRIBIR EL valor
                        #actual.valor = valor
                        #SI NO QUEREMOS SOBREESCRIBIR EL valor ENTONCES NO SE HACE NADA
                        break
    ...
    node [shape=box, height=0.8];\n'''
        ...
        while(filaActual != None):
            ...
            while actual != None:
                nodosInteriores += '\tNodoF'+str(actual.x)+"_C"+str(actual.y)+'[style=\"filled\" label = \"'+str(actual.valor)+'\" fillcolor="'+str(actual.valor)+'" fontcolor="'+str(actual.valor)+'" group = '+str(actual.y)+'];\n'
    ...
    '''
        ...
        #creamos el grafo/diseño
        graph = Source(codigodot, format='svg')
        #pasamos el binario
